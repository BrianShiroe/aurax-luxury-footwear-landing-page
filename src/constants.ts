...
export const PRODUCTS: Product[] = [
  {
    ...
    price: 340,
    description:
      "Ultra-lightweight performance runner designed for speed and agility. Features our proprietary carbon-fiber plate technology.",
    images: [
  ...
  },
  {
    ...
    price: 280,
    description:
      "The ultimate minimalist sneaker. Hand-crafted from Italian pebble-grain leather with a focus on silhouette and pure form.",
    images: [
